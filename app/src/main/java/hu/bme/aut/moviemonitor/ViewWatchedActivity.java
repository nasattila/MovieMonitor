...
public class ViewWatchedActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener
{
    ...
    private void setUpToolNavBar()
    {
        ...
        navigationView.setCheckedItem(R.id.nav_watched);
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item)
    {
        ...
        {
            Toast toast = Toast.makeText(ViewWatchedActivity.this, getString(R.string.author), Toast.LENGTH_LONG);
